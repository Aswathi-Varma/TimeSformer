...
class SegFormerST(nn.Module):
    def __init__(
        ...
        # modify backbone input channels
        backbone.segformer.encoder.patch_embeddings[0].proj = nn.Conv2d(in_chans, 64, kernel_size=(7, 7), stride=(4, 4), padding=(3, 3)) 
        ...
        self.out = nn.Conv2d(768, num_classes, kernel_size=1)
